...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_DjGsPAIm.mjs';
import { manifest } from './manifest_B94A3nDn.mjs';
...
const _page3 = () => import('./pages/authors/page/_slug_.astro.mjs');
const _page4 = () => import('./pages/authors/_single_.astro.mjs');
const _page5 = () => import('./pages/authors.astro.mjs');
const _page6 = () => import('./pages/blog/_single_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/authors/page/[slug].astro", _page3],
    ["src/pages/authors/[single].astro", _page4],
    ["src/pages/authors/index.astro", _page5],
    ["src/pages/blog/[single].astro", _page6],
...
const _args = {
    "middlewareSecret": "08853711-497e-493b-a003-12b57deb0d49",
